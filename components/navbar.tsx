...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div style={{ margin: "12px" }} className="relative">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="hidden md:flex items-center gap-8">
                ...
                >
                  ...
                  <span style={{ padding: "5px 12px" }} className="relative flex items-center gap-1.5 py-2 px-4">
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            <div style={{ padding: "60px 12px 0 0" }} className="flex flex-col items-center gap-6 p-8">
